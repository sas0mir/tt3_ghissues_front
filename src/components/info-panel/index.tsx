      ...
      <div className="relative block w-auto lg:flex justify-around m-4">
        {userInfo &&
            <div className="flex p-4 align-middle text-center">
                <img src={userInfo.avatar_url} alt="avatar" className="w-20 rounded-full mr-4"/>
                <div className="flex flex-col justify-around align-middle text-left">
                    <p className="font-mono">{`username ${userInfo.name}`}</p>
                    <p className="font-mono">{`score ${userInfo.score}`}</p>
                </div>
            </div>
        }
        {repoInfo &&
            <div className="flex flex-col justify-around p-4 align-middle text-center">
